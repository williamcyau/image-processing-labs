...
import time
from lab3 import set_seed, load_pgm, load_kernel, forward, adjoint, cost, cost_grad, normalized_rmse, prior_grad
...
def main():
    ...
    print("Deblurring Experiments with Blur Kernel")
    print("=" * 60)
    ...
    axes[0, 0].set_title("Noisy Blurred Image (y)", fontsize=12, fontweight="bold")
    axes[0, 0].axis("off")
    ...
    plt.tight_layout()
    plt.savefig("d8_deblurring_results.png", dpi=150, bbox_inches="tight")
    print("\n✓ Figure saved: d8_deblurring_results.png")
    ...
    plt.tight_layout()
    plt.savefig("d8_convergence_analysis.png", dpi=150, bbox_inches="tight")
    print("✓ Figure saved: d8_convergence_analysis.png")
